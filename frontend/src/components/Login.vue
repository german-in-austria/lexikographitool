                  ...
                  <v-form ref="registerForm" v-model="valid" lazy-validation>
                    <v-row>
                      <v-col cols="12" sm="6" md="6">
                        <v-text-field v-model="firstName" :rules="[rules.required]" label="Vorname" maxlength="20"
                                      required></v-text-field>
                      </v-col>
                      <v-col cols="12" sm="6" md="6">
                      ...
                      <v-col cols="12">
                      <v-text-field v-model="username" :rules="[rules.required]" label="Benutzername" required></v-text-field>
                    </v-col>
                      <v-col cols="12">
  ...
  methods: {
    ...
    register() {
      if (this.$refs.registerForm.validate()) {
        this.signUp(new Register(this.username,this.email, this.password, this.password,this.firstName, this.lastName))
